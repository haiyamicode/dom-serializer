...
String.prototype.codePointAt == null
    ...
    : // http://mathiasbynens.be/notes/javascript-encoding#surrogate-formulae
        function (input, index) { return input.codePointAt(index); };
/**
...
function encodeXML(input) {
    ...
    while ((match = exports.xmlReplacer.exec(input)) !== null) {
        ...
        if (next === undefined) {
            returnValue += "".concat(input.substring(lastIndex, index), "&#x").concat((0, exports.getCodePoint)(input, index).toString(16), ";");
